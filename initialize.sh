...
echo "  sudo su"
echo "  tmux new-session -s tosinstall"
echo "  /usr/local/bin/tos install --dry-run --modules=ST,SC \\"
echo "    --primary-vip=external --services-network=10.100.0.0/24 \\"
echo "    --load-model=<small|medium> -d --accept-eula"
